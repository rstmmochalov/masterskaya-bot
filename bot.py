...
WELCOME_TEXT = """Доступ в Мастерскую Рукоделия🔥

Стоимость: 990.00 RUB
Срок действия: бессрочно

Хочешь зарабатывать на своём творчестве?

Это закрытый клуб для мастеров любого направления, где ты получишь пошаговый план, как продавать свои изделия.

Внутри клуба ты научишься:
🔹 определять, что именно продавать
🔹 создавать изделия, которые покупают сейчас
🔹 находить клиентов и понимать их потребности
🔹 считать себестоимость, правильно ставить цену и тестировать её
🔹 продавать через социальные сети
🔹 делать продажи стабильными
🔹 увеличивать объёмы продаж и масштабироваться

Бонусные уроки:
🎁 монтаж видео в CapCut
🎁 регистрация и настройка аккаунтов Instagram и TikTok

Подарок:
🎁 130 видеомастер-классов, переведённых на русский язык.

👇 Жми на кнопку ниже и начинай зарабатывать"""
